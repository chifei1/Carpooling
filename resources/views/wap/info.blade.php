...
<head>
    ...
    <script type="text/javascript" src="{{asset('resources/views/wap/js/jquery-1.10.1.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('resources/views/wap/js/alertPopShow.js')}}"></script>
    <script type="text/javascript" src="{{asset('resources/views/wap/js/tanchu.js')}}"></script>
</head>
<body>
<div class="toplink">
    <div class="con">
...
<div class="content">
    <div class="ttl">
        <img src="{{asset('resources/views/wap/images/coin1.png')}}" /><span>车主信息</span>

    </div>

        <ul class="list" id="getId" data-id="{{$data['0']['id']}}" m-id="{{$id}}">
            ...
            <div class="cardexplain">
                <ul class="round">
                    ...
                    <li>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="kuang">
                            <tr>
                                <th>联系人</th>
                                <td><span id="name" data="{{$data['0']['name']}}" class="tdzjp">{{$data['0']['name']}}</span></td>
                            </tr>
                        </table>
                    </li>
                    <li>
                    ...
                    <li>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="kuang">
                            <tr>
                                <th>余座</th>
                                <td><span id="yuzuo" data="{{$data['0']['block']}}" class="tdzjp">{{$data['0']['block']}}</span></td>
                            </tr>
                        </table>
                    </li>
                    <li>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="kuang">
                            <tr>
                                <th>车型</th>
                                <td><span class="tdzjp">{{$data['0']['chexing']}}</span></td>
                            </tr>
                        </table>
                    </li>
                    <li>
                ...
                <div class="ttl" style="padding: 0;">
                    <img src="{{asset('resources/views/wap/images/coin1.png')}}" /><span>已预订乘客</span>

                </div>
                <ul class="list">
                @foreach($other_info as $rows)
                <li style="padding: 10px 20px;">
                <div class="left">
                <div class="line" >QQ昵称：{{$rows['qqname']}}</div>
                <div class="line">名字：{{$rows['nickname']}}</div>
                <div class="time">电话：{{$rows['phone']}}</div>
                </div>
                <div class="right">
                <div class="recommended">
                <a href="#" class="jian">预定 {{$rows['num']}} 座</a>
                </div>
                ...
                @if($id == $data['0']['mid'])
                    <ul>
                        <a href="ownercancel?id={{$data['0']['id']}}">
                ...
                @elseif($b_res == 1)
                    <ul>
                        {{--<a  href="Cancelres?m_id={{$id}}&p_id={{$data['0']['id']}}">--}}
                            <li> <button  id="cancel_reserve" style="background: #ffc24d none repeat scroll 0 0; border: medium none; display: block; margin: auto; height: 3rem;text-align: center; width: 49%;">
                                    <span style="color: #fff; display: inline-block; font-size: 1.2rem; margin: 0rem;">取消预定 </span>
                                </button>
                            </li>
                        {{--</a>--}}
                    </ul>
                @else
                    <ul>
                        <li> <button  class="reserve" id="reserve" style="background: #ffc24d none repeat scroll 0 0; border: medium none; display: block; margin: auto; height: 3rem;text-align: center; width: 49%;">
                                <span style="color: #fff; display: inline-block; font-size: 1.2rem; margin: 0rem;">预定 </span>
                            </button>
                        </li>
                    </ul>
                @endif
