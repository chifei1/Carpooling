...
<div id="header">
        ...
        <p style=" background-color: #e63741; font-size: 20px; border: none;border-radius: 5px;color: #fff;font-size: 18px;font-family: 'Microsoft YaHei';letter-spacing: 5px;">QQ登录注册</p>
</div>
<div class="login-container page">
        <form action="/wap/pregister" method="post" id="loginForm" class="wrap">
                ...
                <div style="margin:0 auto; border-bottom: 1px solid #dcdcdc;" class="input-container">
                        ...
                        <div style="float: right;width: 75%;"><input type="text" name="nickname" value="{{$info['body']['nickname']}}" class="phone_number" placeholder="请输入您的名字(必填)" autocomplete="off" style="width: 100%;height: 45px;border:none;"/></div>
                </div>
                <div style="margin:0 auto; border-bottom: 1px solid #dcdcdc;" class="input-container">
                        <!-- <input type="text" name="username" class="username" placeholder="用户名/邮箱/已验证手机" autocomplete="off"/> -->
                        <span style="width: 25%; display: inline-block;text-align: right;line-height: 45px;">
