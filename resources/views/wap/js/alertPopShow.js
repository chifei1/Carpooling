...
(function(e) {
    ...
    var d = $,
        h = d(window),
        _c1 = d('<div class="weui_mask_transparent" style="z-index:9998;"></div>'),
    ...
    d.extend(e.prototype, {
        _init: function() {
            ...
            j || (j = !0, d("body").append(_c1),d("body").append(c),h.on("resize",
                function() {
                    setTimeout(function() {
                        a._pos()
                    }, 500)
        ...
        show: function() {
            ...
            a.isShow() ? a._cbShow() : (c.css("opacity", "0").removeClass("hide"),_c1.hide(),a._pos(), setTimeout(function() {
                    a._cbShow()
        ...
        hide: function() {
            var a = this;
            a.isHide() ? a._cbHide() : (c.css("opacity", "1").removeClass("show"),_c1.hide(),setTimeout(function() {
                    a._cbHide()
                }, 300), setTimeout(function() {
                    c.animate({
                        opacity: "0"
