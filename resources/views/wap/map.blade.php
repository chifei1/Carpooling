...
{{--<head>--}}
    ...
    {{--<script src="http://webapi.amap.com/maps?v=1.3&key=bdf3984f9d81ca72dcc28cfe4b73e1c9"></script>--}}
...
{{--<script>--}}
    ...
    {{--});--}}
    {{--// 根据起终点经纬度规划驾车导航路线--}}
    {{--driving.search(new AMap.LngLat(116.379028, 39.865042), new AMap.LngLat(117.427281, 38.904719));--}}
...
<script type="text/javascript" src="http://webapi.amap.com/maps?v=1.3&key=bdf3984f9d81ca72dcc28cfe4b73e1c9"></script>
